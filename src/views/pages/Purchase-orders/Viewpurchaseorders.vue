...
<VTable
      ...
      >
       ...
       <!-- <template v-slot:body="{ items }"> -->
        <tbody>
          <!-- {{this.purchaseorders}} -->
          <tr v-for="(item,index) in this.purchaseorders" :key="index">
  ...
  <VCard title="Purchase Order" class="mb-2">
    <VCardText>
      <VRow>
      <VCol cols="12">
  ...
  <!-- @click="resetdetails" -->
    ...
    <VDialog v-model="dialog2" max-width="1000">
   <VCard title="Purchase Order" class="mb-2">
    <VCardText>
      <VRow>
      <VCol cols="12">
          ...
          <VForm class="mt-6" ref="purchaseOrderForm">
            ...
            <VCol
              ...
              <VCol cols="12">
                ...
                <tbody>
                   <tr v-for="(item,index) in this.viewProduct" :key="index">
                      <td class="text-center">{{item.sku_name}}</td>
                      <td class="text-center">{{item.hsn_code}}</td>
                      <td class="text-center">{{item.mrp}}</td>
                      <td class="text-center">{{item.quantity}}</td>
                  ...
                  <tfoot>
                     <tr v-for="(item,index) in this.viewProduct" :key="index">
                      ...
                      <td></td>    
                      <td></td>         
                      <!-- <td class="text-center"> &#8377;{{ item.total_taxableammout }}</td> -->
                      <td></td>
                      <td class="text-center"> &#8377;{{ item.total_cgst }}</td>
                      <td class="text-center"> &#8377;{{ item.total_sgst }}</td>
                      <td class="text-center"> &#8377;{{ item.total_po_amount }}</td>   
                      <td></td> 
                    </tr>
                  </tfoot>
    ...
    methods:{
      ...
      saveProducteditData(){
        ...
        const postData = {
          ...
          })).concat(this.editProduct.filter(editProduct => !existingProductIds.includes(editProduct.brand_product_id)).map(editProduct => ({
      ...
      editrow(itm){
        ...
        //  this.$refs.vtable.items = combinedProducts;
         ...
         this.AllBrandproducts = this.AllBrandproducts.map(product => {
                const editedProduct = this.editProduct.find(brandProduct =>
